...
phoneme_map='60-39'
data_kaldi='data-kaldi/l2arctic_nosil'
data_json='data-json/l2arctic_nosil'
train=train_l2
dev=dev
tests="test"
...
exp_root=exp/l2arctic_nosil/${conf_tag}${suffix}

if [ $stage -le 0 ]; then

    echo -e "${GREEN}Stage 0: data preparation ...${NC}"

    local/l2arctic/data_prep.sh --stage 0 --remove_sil true \
